    ...
    return (
      <>
        ...
        <Modal show={show} onHide={handleClose} animation={false}>
          ...
          <Modal.Body>
          <CartList myCart={myCart } RemoveItem={RemoveItem} setItems={setItems}></CartList>
          </Modal.Body>
          <Modal.Footer>
